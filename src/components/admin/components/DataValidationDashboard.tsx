...
const DataValidationDashboard = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Enhanced Data Integrity Monitor */}
      <DataIntegrityMonitor />

      {/* Traditional Validation Dashboard */}
      <Card>
        <CardHeader>
        ...
        <CardContent className="space-y-4">
          {!validation && !isValidating && (
            <div className="text-center py-8">
              ...
              <p className="text-gray-600">Click "Run Legacy Validation" to check data consistency</p>
              <p className="text-sm text-gray-500 mt-2">Note: Use the enhanced Data Integrity Monitor above for comprehensive checks</p>
            </div>
          )}
