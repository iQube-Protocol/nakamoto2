...
const QryptoCOYNKnowledgeBase = () => {
  ...
  const filteredQryptoItems = searchTerm 
    ? qryptoKB.searchKnowledge(searchTerm)
    : qryptoItems;
  
  const filteredMetaKnytsItems = searchTerm 
    ? metaKnytsKB.searchKnowledge(searchTerm)
    : metaKnytsItems;
              ...
              <div className="mt-2 pt-2 border-t">
                ...
                <div className="flex flex-wrap gap-1">
                  {item.connections.map((connection: string) => (
                    <Badge key={connection} variant="outline" className="text-xs bg-blue-50">
                      {connection}
                    </Badge>
                  ))}
                </div>
    ...
    <div className="h-full flex flex-col">
      <div className="p-4 border-b">
        ...
        <p className="text-sm text-gray-600 mb-4">
          Explore both Qrypto COYN technical knowledge and mẹtaKnyts narrative universe
        </p>
            ...
            <TabsContent value="both" className="mt-0">
              <div className="space-y-6">
                {filteredQryptoItems.length > 0 && (
                  <div>
                    <h3 className="text-lg font-semibold mb-3 text-blue-700">Qrypto COYN Technical Knowledge</h3>
