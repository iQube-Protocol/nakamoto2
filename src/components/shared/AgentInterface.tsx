...
import AgentTabs from './agent/tabs/AgentTabs';
import { useAgentMessages } from './agent/hooks/useAgentMessages';
import './agent/styles/agent-interface.css'; // We'll create this file for styles
